...
class BlocListenerVoterSignUp extends StatelessWidget {
  const BlocListenerVoterSignUp({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<VoterSignUpCubit, VoterSignUpState>(
      listener: (context, state) {
        state.whenOrNull(
          ...
          signUpSuccess: () {
            context.pushNamedAndRemoveUntil(Routes.voterChooseCategory);
          },
