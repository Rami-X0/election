...
class BlocListenerVoterLogin extends StatelessWidget {
  const BlocListenerVoterLogin({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<VoterLoginCubit, VoterLoginState>(
      listener: (context, state) {
        state.whenOrNull(
          ...
          loginSuccess: (data) {
            context.pushNamedAndRemoveUntil(Routes.voterHomeScreen);
          },
