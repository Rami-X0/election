...
class CandiDateLoginDontHaveAccount extends StatelessWidget {
  const CandiDateLoginDontHaveAccount({super.key});
        ...
        children: [
          TextSpan(
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () =>
                  context.pushNamedAndRemoveUntil(Routes.candidateSignUpScreen),
          ),
        ],
      ),
    );
