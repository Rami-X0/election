...
class _CandiDateLoginFormState extends State<CandiDateLoginForm> {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: context.read<CandiDateLoginCubit>().formKey,
      child: Column(
        children: [
          Gap(16.h),
          AppTextFormField(
            keyboardType: TextInputType.emailAddress,
            controller: context.read<CandiDateLoginCubit>().emailController,
            hintText: 'email',
            suffixIcon: FaIcon(
          ...
          AppTextFormField(
            ...
            controller: context.read<CandiDateLoginCubit>().passwordController,
            hintText: 'password',
