...
class CandiDateSignUpForm extends StatefulWidget {
  const CandiDateSignUpForm({super.key});

  @override
  State<CandiDateSignUpForm> createState() => _CandiDateSignUpFormState();
}

class _CandiDateSignUpFormState extends State<CandiDateSignUpForm> {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: context.read<CandiDateSignUpCubit>().formKey,
      child: Column(
        children: [
          AppTextFormField(
            keyboardType: TextInputType.emailAddress,
            controller: context.read<CandiDateSignUpCubit>().nameController,
            hintText: 'name',
            suffixIcon: FaIcon(
          ...
          AppTextFormField(
            keyboardType: TextInputType.emailAddress,
            controller: context.read<CandiDateSignUpCubit>().emailController,
            hintText: 'email',
            suffixIcon: FaIcon(
          ...
          AppTextFormField(
            ...
            controller: context.read<CandiDateSignUpCubit>().passwordController,
            hintText: 'password',
